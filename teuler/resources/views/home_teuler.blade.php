...
<link rel="stylesheet" href="{{ asset('css/home_teuler.css') }}">
    ...
    <div class="left-panel">
        <section class="py-20">
            <div class="container mx-auto px-4 text-center">
                ...
                <a href="/login" class="bg-blue-700 text-white py-3 px-6 rounded-lg shadow hover:bg-blue-900 transition duration-300">Comenzar ahora</a>
            </div>
        </section>
    </div>
        ...
        <section class=" py-12">
            <div class="container mx-auto px-4">    
                    ...
                    <div class="bg-white p-6 rounded-lg shadow text-center">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" class="h-16 w-16 text-blue-600 mx-auto mb-4" style="color: #D491FE;">
