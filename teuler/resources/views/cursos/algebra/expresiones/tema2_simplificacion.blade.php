...
<link rel="stylesheet" href="{{ asset('css/tema2_simplificacion.css') }}">
...
<div class="container mx-auto mb-10 pb-10 pl-10 pr-10">
  <p class="text-lg leading-relaxed text-gray-800">
    La <span class="font-semibold">simplificación de expresiones algebraicas</span> es el proceso de reducir una expresión matemática a su forma más sencilla, combinando términos semejantes, eliminando paréntesis y realizando operaciones básicas. Esto permite resolver problemas de manera más rápida y eficiente, manteniendo la claridad en los cálculos.
  </p>
  ...
  <ol class="list-decimal list-inside mt-4 text-gray-800 space-y-2 flex justify-center">
    ...
    <li class="pasos">
      ...
      <pre class="ec bg-gray-100 p-3 rounded-md mt-2 flex justify-center">(2 + 3)x = 5x</pre>
    </li>
    ...
    <li class="pasos">
      ...
      <pre class="ec bg-gray-100 p-3 rounded-md mt-2 flex justify-center">5x - 5</pre>
    </li>
  </ol>

  <h2 class="ejemplo mt-6 text-xl font-semibold text-gray-900 flex justify-center">Ejemplo con paréntesis:</h2>
  <p class="leading-relaxed text-gray-800 flex justify-center">
    Simplifiquemos:
    <pre class="ec1">3(2x + 4) - 5x</pre>
  </p>
  ...
  <ol class="list-decimal list-inside mt-4 text-gray-800 space-y-2 flex justify-center">
    <li class="pasos">
      ...
      <pre class="ec bg-gray-100 p-3 rounded-md mt-2 flex justify-center">6x + 12 - 5x</pre>
    </li>
    ...
    <li class="pasos">
      ...
      <pre class="ec bg-gray-100 p-3 rounded-md mt-2 flex justify-center">x + 12</pre>
    </li>
  </ol>
...
<a href="/modulo/1/preguntas" class="ejercicio-boton bg-blue-700 text-white py-3 px-6 rounded-lg shadow hover:bg-blue-900 transition duration-300">Empezar bloque de ejercicios</a>
